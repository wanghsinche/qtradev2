...
// exports.redirectURL = 'https://qtrade-proxy.herokuapp.com/api/github_oauth';
exports.redirectURL = 'http://localhost:8011/api/github_oauth';
...
exports.githubOauth = (req, res) => {
    ...
    url.searchParams.set('redirect_uri', exports.redirectURL);
    url.searchParams.set('client_secret', 'bcb560fe14be7a676ce5f60380813dcb2002f962');
    ...
    axios.post(url.href, null, {
        ...
        Object.assign(ssn, {user: resp.data});
        // res.json(buildBody(resp.data, 200));
        res.redirect('/');
    }).catch(err=>res.json(buildBody(null, 403, err)));
}

exports.user = (req, res) => {
    res.json(buildBody(req.session.user), 200);
}
